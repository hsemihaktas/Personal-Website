...
export default function ProjectCard({
  ...
  return (
    <div className="group flex flex-col h-[450px] bg-secondary-dark rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-accent-dark/10 hover:scale-105 border border-transparent hover:border-accent-dark/30">
